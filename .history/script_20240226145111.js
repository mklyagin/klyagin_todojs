...
const setPage = (event) => {
  console.log('Paage is before', currentPage);
...
const taskRender = () => {
  ...
  taskValidation();
  listToPages();
  console.log('Paage is', currentPage);
  console.log('page with content ', taskListPages[currentPage]);
  currentList = taskFilter(taskListPages[currentPage]);
