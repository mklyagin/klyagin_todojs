...
const eventUlHandlerListener = (event) => {
  ...
  switch (event.target.className) {
    ...
    case ('task-title'):
      ...
      event.target.nextElementSibling.addEventListener('blur', saveEdit(event.target.previousElementSibling, event));
      event.target.nextElementSibling.addEventListener('keydown', saveEdit(event.target.previousElementSibling, event));
      break;
    default:
