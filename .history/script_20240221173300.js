...
const checkAll = () => {
  taskList.forEach((task) => {
    ...
    Array.from(ulTask.children).forEach((li) => {
      ...
      console.log(li.children[0].checked);
      console.log(li.children[0].id);
      //li.isDone = checkAllCheckbox.checked;
    });
  ...
  console.log(ulTask.children[0].children[0].checked);
  console.log(ulTask.children[0].children[0].id);
};
