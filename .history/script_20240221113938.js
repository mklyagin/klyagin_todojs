...
const taskRender = () => {
  ...
  console.log(document.getElementsByClassName('check-task').children);
  document.getElementsByClassName('check-task').forEach((checkbox) => {
    checkbox.addEventListener('onchange', checkboxStateListener);
  });
};
