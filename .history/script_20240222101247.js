...
const eventUlHandlerListener = (event) => {
  ...
  switch (event.target.className) {
    ...
    case ('task-title'):
      ...
      previousElementSibling.addEventListener('keydown', saveEdit(event.target.previousElementSibling, event.target));
      previousElementSibling.addEventListener('blur', saveEdit(event.target.previousElementSibling, event.target));
      break;
    default:
