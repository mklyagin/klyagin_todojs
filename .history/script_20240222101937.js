...
const eventUlHandlerListener = (event) => {
  ...
  switch (event.target.className) {
    ...
    case ('task-title'):
      ...
      event.target.previousElementSibling.addEventListener('blur', saveEdit(event.target.previousElementSibling, event));
      event.target.previousElementSibling.addEventListener('keydown', saveEdit(event.target.previousElementSibling, event));
      break;
    default:
